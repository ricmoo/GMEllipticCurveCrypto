...
An Object-C library for Elliptic Curve Digital Signing Algorithm (ECDSA) and for Elliptic Curve Diffie-Hellman (ECDH).
...
This library is largely based on easy-ecc library (https://github.com/kmackay/easy-ecc).
...
NSLog(@"Key Pair: publicKey=%@, privateKey=%@", crypto.publicKeyBase64, crypto.privateKeyBase64);
```
...
char bytes[] = { 2, 209, 124, 132, 44, 97, 246, 29, 115, 148, 76, 110, 57, 155, 173, 187, 
                 15, 173, 71, 57, 164, 223, 53, 93, 124 };
...
char bytes[] = { 56, 164, 34, 250, 121, 21, 2, 18, 65, 4, 161, 90, 126, 145, 111, 204, 151, 65, 
                 181, 4, 231, 177, 117, 154 };
...
// Alice performs...
GMEllipticCurveCrypto *alice = [GMEllipticCurveCrypto cryptoForCurve:GMEllipticCurveSecp192r1];
...
// Bob performs...
GMEllipticCurveCrypto *bob = [GMEllipticCurveCrypto cryptoForCurve:GMEllipticCurveSecp192r1];
...
Kenneth MacKay's easy-ecc is a simple-to-use implementation of essential Elliptic Curve Cryptographic functions, however, the curve used is specified as a compile-time constant.
